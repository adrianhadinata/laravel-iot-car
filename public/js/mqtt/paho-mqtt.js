    ...
    var PahoMQTT = (function (global) {
            ...
            try {
                switch (wireMessage.type) {
                    case MESSAGE_TYPE.CONNACK:
                        ...
                        var sequencedMessages = sequencedMessages.sort(
                            function (a, b) {
                    ...
                    case MESSAGE_TYPE.PUBACK:
                        var sentMessage =
                            this._sentMessages[wireMessage.messageIdentifier];
        ...
        ClientImpl.prototype._receivePublish = function (wireMessage) {
            switch (wireMessage.payloadMessage.qos) {
                ...
                default:
                    throw Error(
                        "Invaild qos=" + wireMmessage.payloadMessage.qos
                    );
            }
        };
        ...
        var Client = function (host, port, path, clientId) {
            ...
            this._setDisconnectedPublishing = function (
                newDisconnectedPublishing
            ) {
            ...
            this._setDisconnectedBufferSize = function (
                newDisconnectedBufferSize
            ) {
