            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <x-navlink href="/framework" :active="request()->is('framework')">Framework</x-navlink>
                  <x-navlink href="/client" :active="request()->is('client')">MQTT</x-navlink>
                  <x-navlink href="/remote" :active="request()->is('remote')">Remote</x-navlink>
