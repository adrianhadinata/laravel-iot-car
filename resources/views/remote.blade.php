<x-layout>
    ...
    <div x-data="{ isModalShow: true, isFirstModalShow: true }">
        ...
        <div class="flex items-center justify-center">
            ...
            <div class="grid grid-cols-3">
                ...
                <!-- Up Arrow Button -->
                <button id="up" class="w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center transform rotate-45 transition duration-200 hover:scale-110 active:scale-125">
                ...
                <!-- Left Arrow Button -->
                <button id="left" class="w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center transform rotate-45 transition duration-200 hover:scale-110 active:scale-125">
                ...
                <!-- Right Arrow Button -->
                <button id="right" class="w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center transform rotate-45 transition duration-200 hover:scale-110 active:scale-125">
                    <span class="transform rotate-45">▲</span>
                </button>
                ...
                <!-- Down Arrow Button -->
                <button id="down" class="w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center transform rotate-45 transition duration-200 hover:scale-110 active:scale-125">
                    <span class="transform rotate-135">▲</span>
                </button>
    ...
    <script src={{ asset('js/mqtt/remote-mqtt.js') }}></script>
</x-layout>